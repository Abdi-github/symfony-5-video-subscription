$(document).ready(function () {
  ...
  var $buttonContainer = $(".comments__rate");
  $buttonContainer.find("#like__link").on("click", function (e) {
    // alert("clikced");
    e.preventDefault();
    ...
    $.ajax({
      ...
      // $("#number__likes_" + commentId).text(res.likes);
      document.getElementById("number__dislikes_" + res.commentId).innerHTML =
        res.dislikes;

      document.getElementById("number__likes_" + res.commentId).innerHTML =
        res.likes;

      document.getElementById("like__up_" + res.commentId).style.color =
        "#29b474";
    });
  });
  ...
  $buttonContainer.find("#dislike__link").on("click", function (e) {
    // alert("clikced");
    e.preventDefault();
    var $link = $(e.currentTarget);
    ...
    $.ajax({
      ...
      document.getElementById("dislike__down_" + res.commentId).style.color =
        "#eb5757";
    });
  });
});
