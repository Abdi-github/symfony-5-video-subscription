 ...
 */
final class Version20211127225528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, plan VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, valid_until VARCHAR(45) NOT NULL, resolution VARCHAR(45) DEFAULT NULL, availability VARCHAR(45) DEFAULT NULL, device VARCHAR(45) DEFAULT NULL, support VARCHAR(45) DEFAULT NULL, str_price_id VARCHAR(45) DEFAULT NULL, UNIQUE INDEX UNIQ_A3C664D3DD5A5B7D (plan), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, subscription_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(45) NOT NULL, last_name VARCHAR(45) NOT NULL, vimeo_api_key VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, free_plan_used TINYINT(1) DEFAULT \'0\' NOT NULL, payment_status TINYINT(1) DEFAULT \'0\' NOT NULL, subscription_valid_until DATETIME DEFAULT NULL, str_customer_id VARCHAR(45) DEFAULT NULL, str_subscription_id VARCHAR(45) DEFAULT NULL, str_price_id VARCHAR(45) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6499A1887DC (subscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
